...
![Netlify Site Overview](/images/oldblogs/setup-contact-form-01.png)

If you click on Forms within Netlify's header, you'll see the contact form appear here. Like magic!

![Netlify Forms showing contact form](/images/oldblogs/setup-contact-form-02.png)
...
![Submit a test on your site's form](/images/oldblogs/setup-contact-form-03.png)

![Check form was submitted in Netlify's submission](/images/oldblogs/setup-contact-form-04.png)
...
![Success Page](/images/oldblogs/setup-contact-form-05.png)
...
![Submit the form as a test](/images/oldblogs/setup-contact-form-06.png)

![Confirm we have the right success page](/images/oldblogs/setup-contact-form-07.png)

![Check the new entry in the Netlify form submissions](/images/oldblogs/setup-contact-form-08.png)
...
<!-- ![Form Notifications](/images/oldblogs/setup-contact-form-.png) other images dont load locally without this line -_- -->

![Form Notifications](/images/oldblogs/setup-contact-form-09.png)

Select the `Add Notification` dropdown, then select the `Email Notification` option.

![Add Email Notification](/images/oldblogs/setup-contact-form-10.png)
...
![Fill out the form](/images/oldblogs/setup-contact-form-11.png)

I submitted another test form, and voila! It went straight to my inbox!

![Test form in my email](/images/oldblogs/setup-contact-form-12.png)
